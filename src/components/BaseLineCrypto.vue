...
<template>
  ...
  >
    ...
    <div class="flex pl-4 pr-4 w-44 items-center text-black dark:text-white">
      <template v-if="crypto?.pricesByCurrencies[currencyActive]?.current_price">
    ...
    <div class="flex flex-1 w-200 items-center text-black dark:text-white pr-3" :ref="(ref) => (chartElement = ref)">
